...
data = json.load(open(f"{WS}/data/report_all.json", encoding="utf-8"))

# 队徽（crestByTeam）与各联赛 logo（logoByCode）已随 report_all.json 一并提供
...
<meta name="description" content="叕中啦 · 五大联赛（英超/西甲/德甲/意甲/法甲）近五赛季平局数据专题：平局率、比分分布、各轮走势与各队平局统计。">
<title>叕中啦 · 五大联赛近五赛季平局数据（英超/西甲/德甲/意甲/法甲）</title>
<style>
:root{
...
.team-table th.namecol, .team-table td.namecol { width:224px; min-width:196px; max-width:260px; text-align:left; padding-left:10px; }
...
<header class="site-head">
  <div class="brand">
    ...
    <span class="brand-txt">
      ...
      <span class="sl">叕中啦 · 五大联赛平局数据站</span>
    </span>
  </div>
...
<div class="container">
  ...
  <div id="viewBig5">
    <div class="section-title" id="big5Title">五大联赛横向对照
  ...
  <div class="footer">
    <div><span class="ft-brand">叕中啦</span> · 五大联赛平局数据站　｜　数据源：<a href="https://github.com/openfootball/football.json" target="_blank">openfootball/football.json</a></div>
    <div class="ft-meta">
...
out = f"{WS}/football_big5_draws.html"
